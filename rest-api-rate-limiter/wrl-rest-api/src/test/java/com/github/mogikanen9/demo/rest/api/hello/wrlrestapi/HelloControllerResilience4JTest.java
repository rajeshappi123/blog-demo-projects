...
public class HelloControllerResilience4JTest {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            Future<String> task = eService.submit(() -> {
                String param = String.format("kozlik%d", val);
                String body = client.getForObject("http://localhost:8080/api/greeting/hello/"+param, String.class);
                assertThat(body).isEqualTo("Hello, "+param+"!");
                return body;
            });
            tasks.add(task);
        }
